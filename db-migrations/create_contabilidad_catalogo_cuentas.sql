...
-- y contabilidad.mc_cuenta automáticamente al arrancar la app con las
-- nuevas entidades McTipoCuenta / McCuenta. Ejecutar este script DESPUÉS
...
--   mc_catalago_cuenta (con typo) era el nombre de tabla del entity stub
--   McCatalogoCuenta, reemplazado por McCuenta → contabilidad.mc_cuenta.
...
-- ── PASO 3 — Campos adicionales de mc_cuenta (saldo importado, referencia legacy) ──
...
ALTER TABLE contabilidad.mc_cuenta ADD COLUMN IF NOT EXISTS saldo_cuenta NUMERIC(18, 2);
ALTER TABLE contabilidad.mc_cuenta ADD COLUMN IF NOT EXISTS control VARCHAR(45);
...
ALTER TABLE contabilidad.mc_cuenta ALTER COLUMN usuario_reg DROP NOT NULL;
ALTER TABLE contabilidad.mc_cuenta ALTER COLUMN fecha_reg DROP NOT NULL;
