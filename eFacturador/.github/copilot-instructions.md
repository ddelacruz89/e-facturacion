...
2. Todos los  create tienen que tener empresas:
     a. con esta implementacion: _private final TenantContext tenantContext;
...
4. For all controllers, i want and enpoint bringing a resume, most of the time it will be id and nombre
5. Use projection queries as first resource to bring data, only if projection is not enough, use entity fetching.
6. todos los criteria deben de tener como busqueda por empresa. Pues es multiempresa.