...
interface Props {
    ...
    onClose: () => void;
    codProvincia: string;
    onSelect: (cabecera: MgMunicipioResumen) => void;
}

const MunicipioCabeceraBuscarModal: React.FC<Props> = ({
    open,
    onClose,
    codProvincia,
    onSelect,
        ...
        async (p = 0) => {
            ...
            try {
                const criteria: MgMunicipioSearchCriteria = {
                    codProvincia: codProvincia || undefined,
                    ...
                    <Table size="small" stickyHeader>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell sx={{ fontWeight: 700, bgcolor: "grey.100" }}>Municipio Cabecera</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {cargando ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={2} align="center" sx={{ py: 4, color: "text.secondary" }}>
                                        No se encontraron municipios cabecera
                                    </TableCell>
                                </TableRow>
                            ) : (
                                resultados.map((r) => (
...
export default MunicipioCabeceraBuscarModal;
